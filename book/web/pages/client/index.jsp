	...
	<script type="text/javascript">
		$(function () {
			...
			$("button.addToCart").click(function () {
				...
				//ajax请求，添加商品到购物车，并在主页显示购物车商品的数量，和最后一次添加的商品名称
...
<body>
	...
	<div id="header">
			...
			<div>
				<%--如果用户还没有登录，显示登陆和注册这连个选项，如果登录了就去掉这连个选项，如果登陆了，我们在Servlet中就会把用户的登录信息存储到Session域中，即Session不为空--%>
				<c:if test="${empty sessionScope.user}">
					<a href="pages/user/login.jsp">登录</a> |
					<a href="pages/user/regist.jsp">注册</a> &nbsp;&nbsp;
				</c:if>
				<%--用户登录信息不为空，则显示登录成功后的信息：你好，韩总--%>
